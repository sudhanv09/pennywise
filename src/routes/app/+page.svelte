...
<div class="flex w-full flex-col gap-6 px-6 pb-10 pt-6">
  ...
  >
    ...
    >
      ...
      <CardContent class="pt-1">
        <div
          class="text-3xl font-semibold text-emerald-600 dark:text-emerald-400"
        >
    ...
    >
      ...
      <Card
        class="order-1 flex flex-col lg:order-3 lg:col-span-2 lg:col-start-5 xl:col-span-3 xl:col-start-7"
      >
        ...
        <CardContent class="flex-1 pt-4">
          ...
          {:else}
            <div
              class="flex h-full items-center justify-center rounded-lg border border-dashed border-muted-foreground/40 p-6 text-sm text-muted-foreground"
            >
      ...
      <Card
        class="order-2 flex flex-col lg:order-2 lg:col-span-2 lg:col-start-5 xl:col-span-3 xl:col-start-7"
      >
        <CardHeader class="space-y-1 pb-0">
          <CardTitle>Spending by Category</CardTitle>
          <CardDescription
            >Track where your expenses concentrate.</CardDescription
          >
        </CardHeader>
      ...
      <Card
        class="order-3 flex flex-col lg:order-1 lg:col-span-4 lg:row-span-2 xl:col-span-6"
      >
        <CardHeader class="space-y-1 pb-0">
